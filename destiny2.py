...
class Destiny2(object):
    ...
    @staticmethod
    def get_destiny_entity_definition(entity_type, this_hash):
        this_api = API()
        req = API.bungie_api + "/Destiny2/Manifest/" + entity_type + "/" + this_hash
        return this_api.call_bungie_api(req)
    ...
    def get_profile(membership_type, membership_id):
        this_api = API()
        req = API.bungie_api + "/Platform/Destiny2/" + str(membership_type) + "/Profile/" + str(membership_id) + "/?components=100,102,200"
        return this_api.call_bungie_api(req)

    @staticmethod
    def get_character(membership_type, membership_id, character_id):
        this_api = API()
        req = API.bungie_api + "/Destiny2/" + str(membership_type) + "/Profile/" + str(membership_id) + "/Character/" + str(character_id) + "/"
        return this_api.call_bungie_api(req)
    ...
    def get_vendors(membership_type, membership_id, character_id):
        this_api = API()
        req = API.bungie_api + "/Destiny2/" + str(membership_type) + "/Profile/" + str(membership_id) + "/Character/" + str(
    ...
    def get_leaderboards(membership_type, membership_id):
        this_api = API()
        req = API.bungie_api + "/Destiny2/" + str(membership_type) + "/Account/" + str(membership_id) + "/Stats/Leaderboards/"
        return this_api.call_bungie_api(req)
    ...
    def get_activity_history(membership_type, membership_id, character_id):
        this_api = API()
        req = API.bungie_api + "/Destiny2/" + str(membership_type) + "/Account/" + str(membership_id) + "/Character/" + str(
